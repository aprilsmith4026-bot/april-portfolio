                    ...
                    <div className="mt-10 grid gap-x-12 gap-y-10 md:grid-cols-2">
                        ...
                        <div className="border-t border-zinc-300 pt-6">
                            ...
                            <p className="mt-3 leading-7 text-zinc-700">
                                ...
                                working. They had questions throughout the day about the workflow,
                                exceptions, and what needed to happen in different situations. We
                                met daily, but I also stayed available between meetings so they
                                could keep moving.
                            </p>
                        </div>
                        ...
                        <div className="border-t border-zinc-300 pt-6">
                            ...
                            <p className="mt-3 leading-7 text-zinc-700">
                                ...
                                starting with a blank page. I also learned that documentation can
                                only take you so far. More questions came up once they started
                                building, and I needed to fill in those details as we went.
                            </p>
                        </div>
                        ...
                        <div className="border-t border-zinc-300 pt-6">
                            ...
                            <p className="mt-3 leading-7 text-zinc-700">
                                One of the biggest things I learned was that developers could not
                                just create anything we wanted. There were technical guidelines
                                they had to work within. Sometimes we could adjust the development
                                approach, and sometimes the process itself needed to change. I
                                became the person who could explain how the process worked and help
                                work through those decisions with them.
                            </p>
                        </div>
                        ...
                        <div className="border-t border-zinc-300 pt-6">
                            ...
                            <p className="mt-3 leading-7 text-zinc-700">
                                ...
                                automated. I was surprised by how much we were ultimately able to
                                automate. By the end of the project, the onboarding initiation
      ...
      ========================================================= */}
            <section className="border-t border-zinc-200 bg-white">
                <div className="mx-auto flex max-w-6xl flex-col gap-6 px-8 py-10 sm:flex-row sm:items-center sm:justify-between">
                    <Link
                        href="/#selected-work"
                        className="font-medium text-zinc-600 transition hover:text-blue-700"
                    >
                        ← Back to Selected Work
                    </Link>
                    ...
                    <Link
                        href="/#how-i-work"
                        className="inline-flex items-center justify-center border border-zinc-400 px-6 py-4 text-sm font-semibold uppercase tracking-[0.2em] text-blue-700 transition hover:border-blue-700 hover:bg-blue-50"
                    >
                        View How I Work →
                    </Link>
                </div>
            ...
            <footer className="border-t border-zinc-200 bg-zinc-50">
                <div className="mx-auto flex max-w-6xl flex-col gap-6 px-8 py-8 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm font-medium text-zinc-600 transition hover:text-blue-700">
